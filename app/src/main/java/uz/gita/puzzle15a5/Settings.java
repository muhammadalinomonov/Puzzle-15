...
//        this.music = MediaPlayer.create(context, R.raw.long_music);
        touch = MediaPlayer.create(context, R.raw.sound_click);
//        music.setLooping(true);
    ...
    /*public MediaPlayer getMusic() {
        if (music == null) {
            music = MediaPlayer.create(Settings.getContext(), R.raw.long_music);
        }
        return music;
    }*/
...
//        music = null;
    ...
    public int getFirstScore() {
        return sharedPreferences.getInt("rek0", 100000);
    }
